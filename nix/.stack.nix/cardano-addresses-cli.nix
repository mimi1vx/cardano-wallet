{ system
  ...
  ({
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "cardano-addresses-cli"; version = "3.1.1"; };
      license = "Apache-2.0";
      copyright = "2020 IOHK";
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchgit {
      ...
      rev = "817896ccf65cbd088eeff963f859ff4f6e8a9825";
      sha256 = "1qnnn3xb7j72dzh11r7d8dlpk5bwkv6vz7mmnqh8fq4zij44650p";
      });
